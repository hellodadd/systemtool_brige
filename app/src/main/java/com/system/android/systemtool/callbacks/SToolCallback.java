...
/**
 * Base class for SystemTool callbacks.
 *
...
public abstract class SToolCallback implements Comparable<SToolCallback> {
	 ...
	 * can be set instead. The values are just for orientation though, SystemTool doesn't enforce any
	...
	/**
	 * Base class for SystemTool callback parameters.
	 */
