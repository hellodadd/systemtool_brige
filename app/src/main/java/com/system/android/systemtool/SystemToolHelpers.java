...
public final class SystemToolHelpers {
	...
	public static Class<?> findClass(String className, ClassLoader classLoader) {
		if (classLoader == null)
			classLoader = SystemToolBridge.BOOTCLASSLOADER;
		try {
	...
	public static STool_MethodHk.Unhook getMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
		...
		return SystemToolBridge.hookMethod(m, callback);
	}
	 ...
	 * {@link SystemToolBridge#hookMethod}.
	 *
	 ...
	 * methods, e.g. to override parameters only for the outer call. The SystemTool framework uses this
