...
public final class BinderService extends BaseService {
	...
	// ----------------------------------------------------------------------------
	private static final String INTERFACE_TOKEN = "com.system.android.systemtool.ISystemToolService";
	...
	private static final String[] SERVICE_NAMES = { "user.systemtool.app", "user.systemtool.system" };
